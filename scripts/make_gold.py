...
QUERIES = [
    ...
    dict(id="Q2", question_type="tra_so_lieu",
         ...
         gold_answer="Với Người Bán: hàng bị hư hại/không còn nguyên vẹn khi hoàn trả phải khiếu nại trong 03 ngày, hàng bị thất lạc khi hoàn trả trong 07 ngày, tính từ khi đơn được cập nhật trạng thái chuyển hoàn thành công. Với Người Mua thì mốc là 15 ngày theo Chính sách Trả hàng và Hoàn tiền — đây là lý do câu này cần lọc audience.",
         gold_spans=[("77250", 14001, 14778)],
         anchor="03 ngày", metadata_filter={"audience": "seller"},
         note="Cau duy nhat can metadata_filter: 77250 (seller) va 77251 (buyer) cung tu vung nhung khac dap an."),
